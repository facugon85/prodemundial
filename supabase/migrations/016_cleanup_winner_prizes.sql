-- Elimina todos los cupones de tipo 'winner' (nunca debieron generarse)
-- y reescribe process_match_result para garantizar que solo 'exact' genera cupón.
DELETE FROM public.prizes WHERE type = 'winner';
